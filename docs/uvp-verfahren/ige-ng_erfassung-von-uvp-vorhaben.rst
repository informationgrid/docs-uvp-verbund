...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_kontaktdaten.png
   :alt: Verknüpfung mit den Adressen
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_adresse-hinzufuegen.png
   :alt: Fenster Adresse hinzufügen
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_vorhaben-adresse_person.png
   :alt: Adresse - Angabe einer Person
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_vorhaben-adresse_organisation.png
   :alt: Adresse - Angabe einer Organisation
   :align: left
   :scale: 80
   :figwidth: 100%
...
In der Suche kann entweder nach der Organisation, den Nachnamen oder den Vornamen oder einer Kombination aus den Feldern gesucht werden. Die gefundenen Adressen werden in einer Trefferliste angezeigt. Durch ein einfaches Klicken auf eine Adresse, wird diese markiert und durch ein anschließendes Klicken auf "ÜBERNEHMEN" in die Kontaktdaten des Vorhabens übernommen.

.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_vorhaben-adresse_suche.png
   :alt: Suche in den Adressen
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_vorhaben-adresse_uebernehmen.png
   :alt: Adresse übernehmen
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_vorhaben-adresse_auswahlmenue.png
   :alt: Auswahlmenü
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_raumbezug_viewer.png
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_raumbezug_freier-raumbezug.png
   :alt: Freier Raumbezug und BoundingBox
   :align: left
   :scale: 80
   :figwidth: 100%
...
..hint:: Das Datum wird im Portal nicht veröffentlicht, es dient nur statistischen Zwecken.
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_vorpruefung-durchgefuehrt.png
   :alt: Checkbox Vorprüfung durchgeführt
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_zeitraum-der-auslegung.png
   :alt: Zeitraum der Auslegung
   :align: left
   :scale: 80
   :figwidth: 100%
...
..hint:: Der Auslegungszeitraum beginnt in dem Fall am 26.09.2022, 0:00 Uhr und geht bis 24.10.2022, 24:00 Uhr.
...
Die Checkbox finden Sie unter jeder Auflistung.


**Auslegungsinformationen (Pflichtfeld)**

.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_auslegungsinformation.png
   :alt: Auflistung der Auslegungsinformationen
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_informationen-zum-eroerterungstermin.png
   :alt: Auflistung von Informationen zum Erörterungstermin
   :align: left
   :scale: 80
   :figwidth: 100%

Abb.: Auflistung von Informationen zum Erörterungstermin
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_auslegungsinformation.png
   :alt: Auflistungen von Auslegungsinformationen
   :align: left
   :scale: 80
   :figwidth: 100%

Abb.: Auflistungen von Auslegungsinformationen
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_felder_entscheidung.png
   :alt: Tabelle Entscheidung
   :align: left
   :scale: 80
   :figwidth: 100%
...
Abb.: Auflistung der Auslegungsinformationen
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_verlinkung_link-angeben.png
   :alt: Dialogfenster Link angeben
   :align: left
   :scale: 80
   :figwidth: 100%
...
.. figure:: ../img-ige-ng/vorhaben/ige-ng_verlinkung_eintrag-bearbeiten.png
   :alt: Dialogfenster Eintrag bearbeiten
   :align: left
   :scale: 80
   :figwidth: 100%
